...
| Quản lý ứng dụng | `AppsAdminPanel` | **Chỉ admin** — CRUD app; chọn ảnh icon tối đa 1MB, thu về PNG 46 × 46 trước khi upload (app cũ chưa có ảnh vẫn hiện chữ trên nền màu); bảng hiển thị grant trực tiếp/tổng user; modal tải danh sách user khi mở, checkbox phản ánh quyền hiện tại và bộ lọc “Chỉ người chưa được phân quyền” chỉ ẩn các dòng đã chọn. Khi lưu, frontend tính delta thêm/gỡ. BE tự chặn 403 nếu gọi thẳng API, ẩn tab chỉ là UX |
